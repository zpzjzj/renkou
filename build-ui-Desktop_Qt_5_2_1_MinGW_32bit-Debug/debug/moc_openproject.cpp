...
QT_MOC_LITERAL(4, 55, 19)
    ...
    "OpenProject\0selectPathButtonClicked\0"
    "\0openButtonClicked\0cancelButtonClicked\0"
};
...
void OpenProject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->selectPathButtonClicked(); break;
...
void *OpenProject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "UiItem"))
        return static_cast< UiItem*>(const_cast< OpenProject*>(this));

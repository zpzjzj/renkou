...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DataTreeWidget_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 79, 6)
    ...
    "DataTreeWidget\0updateDomElement\0\0"
    "QTreeWidgetItem*\0item\0column\0"
    "importBtnClicked\0string\0"
};
...
void DataTreeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DataTreeWidget *_t = static_cast<DataTreeWidget *>(_o);
        switch (_id) {
        case 0: _t->updateDomElement((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->importBtnClicked((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObject DataTreeWidget::staticMetaObject = {
    { &QTreeWidget::staticMetaObject, qt_meta_stringdata_DataTreeWidget.data,
      qt_meta_data_DataTreeWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DataTreeWidget.stringdata))
        return static_cast<void*>(const_cast< DataTreeWidget*>(this));
